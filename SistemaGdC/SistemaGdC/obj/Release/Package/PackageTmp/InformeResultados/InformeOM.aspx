<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InformeOM.aspx.cs" Inherits="SistemaGdC.InformeResultados.InformeOM" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <link href="~/Content/bootstrap.css" rel="stylesheet" media="screen" />
    <h2>&nbsp;</h2>
    <h2 style="color: white"><b>Ingreso de Informe de Oportunidad de Mejora</b></h2>
    <div class="row">
        <div class="col-xs-12">
