                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:RequiredFieldValidator ValidationGroup="validarInforme" ID="RFVddlIndicador" Style="color: red;" SetFocusOnError="true" ControlToValidate="ddlIndicador" InitialValue="0" runat="server" ErrorMessage="Seleccione Mejora." Display="Dynamic" />
                                </div>
                                <div class="col-md-2">
