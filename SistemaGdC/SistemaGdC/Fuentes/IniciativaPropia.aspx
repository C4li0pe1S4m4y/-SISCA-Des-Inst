<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IniciativaPropia.aspx.cs" Inherits="SistemaGdC.Fuentes.IniciativaPropia" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>&nbsp;</h2>
    <h2 style="color: white"><b>Iniciativa Propia</b></h2>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label>Tipo Mejora: </label>
                                    <asp:DropDownList ID="ddlTipoMejora" CssClass="form-control input" Width="100%" runat="server" Enabled="true"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ValidationGroup="validarInforme" ID="RFVddlTipoMejora" Style="color: red;" SetFocusOnError="true" ControlToValidate="ddlTipoMejora" InitialValue="0" runat="server" ErrorMessage="Seleccione Mejora." Display="Dynamic" />
                                </div>
                                <div class="col-md-2">
