<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadoAcciones.aspx.cs" Inherits="SistemaGdC.InformeResultados.Acciones.ListadoAcciones" %>
                        ...
                        <div class="panel-body">
                            <div class="row" id="panel1" runat="server">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Enlace: </label>
                                        <asp:DropDownList ID="ddlEnlace" CssClass="form-control input" Width="100%" runat="server" Enabled="false"></asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlLider" CssClass="form-control input" Width="100%" runat="server" Enabled="false"></asp:DropDownList>
