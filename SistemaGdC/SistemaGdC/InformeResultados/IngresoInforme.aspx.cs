    ...
    public partial class IngresoInforme : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                txtanio.Text = anio;
                txtInforme.Text = cInformeEI.ultimoInforme(anio).ToString();
        ...
        protected void btnGuardar_Click(object sender, EventArgs e) //ok
        {
            ...
            if(!existeHallazgo)
            {
                ...
                if (mInformeEI.id_status==0)
                {
                    ...
                    {
                        //gvListadoAcciones.DataSource = cInformeEI.ListadoAcciones(int.Parse(txtanio.Text), int.Parse(txtInforme.Text), 0, "todos");
        ...
        protected void ddlDependencia_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (idDependencia > 0)
            {
                ...
                //mEmpleado = cEmpleado.Obtner_Empleado()
                //cInformeEI.dllEmpleado(ddlEmpleado, idDependencia);
            }
        ...
        {
            txtInforme.Text = cInformeEI.ultimoInforme(txtanio.Text).ToString();
        }

        protected void btnGuardarEncabezado_Click(object sender, EventArgs e)
        {
            mInformeEI.anio = int.Parse(txtanio.Text);
            mInformeEI.no_informe_ei = int.Parse(txtInforme.Text);
